...
}, function(defs, callback, root, v0, inputs, realV0) {
  return { buf_: [], callback: callback, root_: root, v0_: v0, completed_: [], pumpOn_: false, isDone_: false, inputs_: inputs, realV0_: realV0 };
});
