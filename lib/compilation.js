  ...
  function translate(root) {
    return root.accept({
      ...
      fork: function(node) {
        ...
        var mergeNode = treeFromDsl(comp(func.name || 'MERGE OF ' + node.key(), func), '_SYNTHETIC_');
...
var Compiler = Top.extend({
  ...
  var defaultOptions = { branchOp: 'SINGLE', requireUniqueNames: true }; //, translateErrors: true, requireUniqueNames: true};
