...
}, function(defs, callback) {
  return { buf_: [], callback: callback }
});
    ...
    try {
      while (completed.length > 0) {
        ...
        ts.forEach(function(t) {
          ...
          var nextOfT = next.bind(null, t, execution);
  ...
  return {
    asFunction: function() {
      return function(e) {
        ...
        var next = args.pop();
        if (e) return next(e);
        var execution = Execution.new_(next);
